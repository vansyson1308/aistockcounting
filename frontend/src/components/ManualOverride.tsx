  ...
  return (
    <div className="space-y-3 rounded-xl bg-white p-4 shadow">
      ...
      <div className="flex gap-2">
        <button
          className={`flex-1 rounded-lg border p-3 ${props.isAICorrect === true ? 'bg-emerald-600 text-white' : 'bg-white'}`}
        ...
        <button
          className={`flex-1 rounded-lg border p-3 ${props.isAICorrect === false ? 'bg-rose-600 text-white' : 'bg-white'}`}
